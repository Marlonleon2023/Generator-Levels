...
class PlantManager {
    ...
    loadPlantList() {
        ...
        this.allPlants = [
            ...
            "bloomerang", "cabbagepult", "iceburg", "twinsunflower"
        ];
    ...
    updateSelectedPlantsDisplay() {
        ...
        this.selectedPlants.forEach((plant, index) => {
            ...
            col.innerHTML = `
                <div class="selected-plant-card" data-plant="${plant}">
        ...
        // Click en card para remover
        container.querySelectorAll('.selected-plant-card').forEach(card => {
    ...
    updateExcludedPlantsDisplay() {
        ...
        this.excludedPlants.forEach((plant, index) => {
            ...
            col.innerHTML = `
                <div class="excluded-plant-card" data-plant="${plant}">
                    <div class="plant-img-small">
                        <img src="${imageUrl}" alt="${plant}" class="img-fluid"
        ...
        // Click en card para remover exclusión
        container.querySelectorAll('.excluded-plant-card').forEach(card => {
            card.addEventListener('click', () => {
                const plant = card.dataset.plant;
